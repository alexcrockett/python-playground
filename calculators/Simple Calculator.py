...
This is a simple calculator that performs basic arithmetic operations on two numbers. It takes two inputs from the user and performs the selected operation.
"""
...
def simple_calc_ui(no_1, no_2):
    select_method = input(
        "A = add, B = subtract, C = multiply, D = divide, E = restart: "
    )
